...
* **Automation Testing:** Python, Selenium WebDriver, Pytest, Robot Framework, Page Object Model (POM).
* **API & Performance:** Postman, SoapUI, JMeter (Load & Stress testing).
* **Cloud & DevOps:** Kubernetes (Pods, Nodes, Namespaces), Jenkins, Git, GitHub.
* **Domain Expertise:** 5G Core Network Testing (PCF, BSF), SDN-NFV Transformation.
* **Methodologies:** Agile/Scrum, Defect Management (JIRA, ALM Octane).

---

### 🚀 Professional Highlights

* **Framework Development:** Designed Python frameworks reducing manual effort by 40%.
* **5G Core Testing:** Validated PCF and BSF modules for high-scale telecom projects.
* **Performance Engineering:** Conducted benchmarking for system resiliency and scalability.
* **Cloud Infrastructure:** Hands-on experience with Kubernetes deployments and Linux environments.
...
### 📬 Let's Connect
- **LinkedIn:** https://www.linkedin.com/in/vanga-madhu-1931b0233/ 
- **Portfolio:** Madhuitsdet@gmail.com
- **Mobile:** 7730038541
